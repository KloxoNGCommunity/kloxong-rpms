...
BuildRequires: autoconf, libtool, doxygen, apr-devel >= 1.5.0
...
%changelog
* Sat Jun 13 2015 Mustafa Ramadhan <mustafa@bigraf.com> 1.5.4-1.mr
- update to 1.5.4

* Wed Aug 14 2013 Mustafa Ramadhan <mustafa@bigraf.com> 1.5.2-1.mr
- recompile
- change libuuid-devel to e2fsprogs-devel (Centos 5 compatibility reason)
