...
%prep
%setup -n mod_hostinglimits-%{version}

%build
cmake -DCPANEL:BOOL=TRUE -DHTTPD_INCLUDE_DIR=/opt/rh/httpd24/root/%{_includedir}/httpd \
 -DHTTPD_MODULES=/opt/rh/httpd24/root/etc/httpd/modules/ -DHTTPD_BIN=/opt/rh/httpd24/usr/bin/ \
 -DAPRUTIL_INCLUDE_DIR=/opt/rh/httpd24/root/%{_includedir}/apr-1/ -DAPR_LIBRARY=/opt/rh/httpd24/root/%{_libdir}/libapr-1.so \
 -DAPACHECTL=/opt/rh/httpd24/root/usr/sbin/apachectl -DAPR_INCLUDE_DIR=/opt/rh/httpd24/root/%{_includedir}/apr-1/
make

%install
mkdir -p $RPM_BUILD_ROOT/opt/rh/httpd24/root/%{_libdir}/httpd/modules/ $RPM_BUILD_ROOT/opt/rh/httpd24/root/%{_sysconfdir}/httpd/conf.d/
install -D lib/mod_hostinglimits.so $RPM_BUILD_ROOT/opt/rh/httpd24/root/%{_libdir}/httpd/modules/
install -m 644 -D %{SOURCE102} $RPM_BUILD_ROOT/opt/rh/httpd24/root/%{_sysconfdir}/httpd/conf.d/
...
%files
%defattr(-,root,root,-)
/opt/rh/httpd24/root/%{_libdir}/httpd/modules/*
%config(noreplace) /opt/rh/httpd24/root/%{_sysconfdir}/httpd/conf.d/*

%changelog
* Wed Feb 18 2015 Alexey Berezhok <alexey_com@ukr.net> 1.0-21
...
* Sat Aug 09 2014 Alexey Berezhok <alexey_com@ukr.net> 1.0-17
...
* Thu Jun 06 2013 Alexey Berezhok <alexey_com@ukr.net> 1.0-12
...
* Thu Feb 16 2012 Alexey Berezhok <alexey_com@ukr.net> 0.9-5
...
* Tue May 24 2011 Alexey Berezhok <alexey_com@ukr.net> 0.7-10
...
* Mon Mar 14 2011 Alexey Berezhok <alexey_com@ukr.net> 0.7-8
...
* Tue Jan 04 2011 Anton Volkov <avolkov@cloudlinux.com> 0.7-4
...
* Thu Dec 09 2010 Alexey Berezhok <alexey_com@ukr.net> 0.7-1
- Add new spec file 3 rpm in 1 spec file
  - Add fix in *.cmake file for building under H-Sphere 3.1

* Wed Dec 08 2010 Anton Volkov <avolkov@cloudlinux.com> 0.7-1  
- Add new CMakeList and *.cmake files for RPM building

* Tue Dec 07 2010 Anton Volkov <avolkov@cloudlinux.com> 0.7-1                                                                                                   
...
* Sun Dec 05 2010 Igor Seletskiy <iseletsk@gmail.com>
...
* Fri Jul 02 2010 Alexey Berezhok <alexey_com@ukr.net>
...
* Thu Apr 08 2010 Alexey Berezhok <alexey_com@ukr.net>
- Add include in spec <commit: e94d248f2d49d23fd9fc9b3f6b25329a27f39941>

* Wed Apr 07 2010 Alexey Berezhok <alexey_com@ukr.net>
...
* Fri Apr 02 2010 Alexey Berezhok <alexey_com@ukr.net>
...
* Fri Mar 05 2010 Igor Seletskiy <iseletsk@piter.seletskiy.com>
...
* Mon Feb 08 2010 Alexey Berezhok <alexey_com@ukr.net>
...
* Mon Feb 01 2010 Alexey Berezhok <alexey_com@ukr.net>
...
* Tue Dec 08 2009 Alexey Berezhok <alexey_com@ukr.net>
- spec added <commit: 0ef33419b8bfb6ad532591e16b36d3458dbd2efc>

* Mon Dec 07 2009 Alexey Berezhok <alexey_com@ukr.net>
