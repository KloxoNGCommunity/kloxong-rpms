...
Source0: http://projects.marsching.org/suphp/download/suphp-%{version}.tar.bz2
Patch0: suphp-0.7.2_accept-httpd-2.4.patch
BuildRoot: %{_tmppath}/%{name}-%{version}-%{release}-root

BuildRequires: httpd-devel >= 2.0, gcc-c++, automake, autoconf, libtool, apr-devel
