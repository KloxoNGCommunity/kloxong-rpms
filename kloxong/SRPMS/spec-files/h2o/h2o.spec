...
Source0: https://github.com/h2o/h2o/archive/%{name}-%{version}.tar.bz2
Source1: h2o_index.html
...
%if %{with_systemd}
%if 0%{?suse_version}
BuildRequiyunres: systemd-rpm-macros
%{?systemd_requires}
%else
...
install -m 644 -p $RPM_SOURCE_DIR/h2o_index.html \
...
%changelog
* Wed Jul 29 2015 Mustafa Ramadhan <mustafa@bigraf.com> - 1.4.2-2
- rename index.html to h2o_index.html
