...
%attr(0700, root, root) %dir %{kloxo}/squirrelmail/prefs
%attr(0700, root, root) %dir %{kloxo}/squirrelmail/attach
...
* Wed Mar 6 2013 Mustafa Ramadhan <mustafa@bigraf.com> - 1.4.22-5.mr
- fix config_local.php

* Mon Mar 4 2013 Mustafa Ramadhan <mustafa@bigraf.com> - 1.4.22-4.mr
- set accept dovecot beside courier

* Tue Jan 22 2013 Mustafa Ramadhan <mustafa@bigraf.com> - 1.4.22-3.mr
- change email from mustafa.ramadhan@lxcenter.org to mustafa@bigraf.com
- disable cron function

* Sun Sep 23 2012 Mustafa Ramadhan <mustafa.ramadhan@lxcenter.org> - 1.4.22-2.lx
- rename
