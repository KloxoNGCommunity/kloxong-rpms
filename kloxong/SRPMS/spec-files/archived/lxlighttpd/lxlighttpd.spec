...
#Patch0: lxlighttpd_1.4.29_ssl_no_ecdh.patch
...
%prep
%setup -q
#%patch0 -p1 -b .network.c

%build
%configure \
	--program-prefix= \
	--prefix=/usr/local/lxlabs/ext/%{name}/ \
	--exec-prefix=/usr/local/lxlabs/ext/%{name}/ \
	--bindir=/usr/local/lxlabs/ext/%{name}/bin \
	--sbindir=/usr/local/lxlabs/ext/%{name}/sbin/ \
	--libdir=/usr/local/lxlabs/ext/%{name}/lib/ \
	--mandir=/usr/local/lxlabs/ext/%{name}/share/man/ \
    	--with-gdbm \
    	--with-mysql \
    	--with-openssl \
    	--with-lua
...
%dir %attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_access.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_access.so"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_accesslog.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_accesslog.so"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_alias.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_alias.so"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_auth.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_auth.so"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_cgi.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_cgi.so"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_cml.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_cml.so"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_compress.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_compress.so"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_dirlisting.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_dirlisting.so"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_evasive.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_evasive.so"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_evhost.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_evhost.so"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_expire.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_expire.so"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_extforward.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_extforward.so"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_fastcgi.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_fastcgi.so"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_flv_streaming.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_flv_streaming.so"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_indexfile.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_indexfile.so"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_magnet.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_magnet.so"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_mysql_vhost.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_mysql_vhost.so"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_proxy.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_proxy.so"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_redirect.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_redirect.so"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_rewrite.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_rewrite.so"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_rrdtool.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_rrdtool.so"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_scgi.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_scgi.so"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_secdownload.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_secdownload.so"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_setenv.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_setenv.so"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_simple_vhost.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_simple_vhost.so"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_ssi.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_ssi.so"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_staticfile.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_staticfile.so"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_status.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_status.so"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_trigger_b4_dl.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_trigger_b4_dl.so"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_userdir.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_userdir.so"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_usertrack.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_usertrack.so"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_webdav.la"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/lib/mod_webdav.so"
%dir %attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/sbin"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/sbin/lighttpd"
%attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/sbin/lighttpd-angel"
%dir %attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/share"
%dir %attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/share/man"
%dir %attr(0755 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/share/man/man8"
%attr(0644 lxlabs lxlabs) "/usr/local/lxlabs/ext/%{name}/share/man/man8/lighttpd.8"

%changelog
* Fri Jan 18 2013 Mustafa Ramadhan <mustafa@bigraf.com> 1.4.32-2.mr
- recompile

* Tue Dec 12 2012 Mustafa Ramadhan <mustafa.ramadhan@lxcenter.org> - 1.4.32-2.lx.el5
- update to 1.4.32

* Mon Sep 17 2012 Mustafa Ramadhan <mustafa.ramadhan@lxcenter.org> 1.4.31-2.lx.el5
- Update to 1.4.31
