...
Source0: ftp://ftp.horde.org/pub/horde-webmail/%{packagename}-%{portionname}-core-%{version}.tar.bz2

BuildRoot: %{_tmppath}/%{name}-%{version}-%{release}-root-%(%{__id_u} -n)
BuildArch: noarch
Provides: webmail
Obsoletes: kloxong-egroupware-gallery, kloxomr-webmail-egroupware-gallery-core
Requires: kloxo-webmail-egroupware
...
%prep
%setup -q -n %{packagename}-%{portionname}-core-%{version}
