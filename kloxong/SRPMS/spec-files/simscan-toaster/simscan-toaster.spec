...
export CFLAGS=" -fsyntax-only -fPIE -fno-ident -fno-strict-aliasing -Wno-deprecated-declarations -Wno-implicit-function-declaration -Wno-misleading-indentation -Wno-unused-result -Wformat=2 -Wno-format-truncation -Wno-builtin-declaration-mismatch"
