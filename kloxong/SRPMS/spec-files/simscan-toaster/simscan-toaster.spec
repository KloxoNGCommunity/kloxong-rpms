...
export CFLAGS="%{cflags} -fno-strict-aliasing -Wno-deprecated-declarations -Wextra -pedantic -Wno-implicit-function-declaration -Wno-misleading-indentation -Wno-unused-result -Wformat=2 -Wno-format-truncation"
export LDFLAGS="%{ldflags} -fno-strict-aliasing -Wno-deprecated-declarations -Wextra -pedantic -Wno-implicit-function-declaration -Wno-misleading-indentation -Wno-unused-result -Wformat=2 -Wno-format-truncation"
%endif
